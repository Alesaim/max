               ...
               <form method="post" enctype="multipart/form-data" role="form" class="form-horizontal">
                  ...
                  <div class="nav-tabs-custom">
                     <ul class="nav nav-tabs admin">
                        <li><a class="active" href="http://invoices.techhut.live/admin/profile"><i class="fa fa-cog"></i> <span class="hidden-xs">General Settings</span>   </a></li>
                        <li><a class="" href="http://invoices.techhut.live/admin/profile/change_password"><i class="fa fa-lock"></i> <span class="hidden-xs">Change Password</span></a></li>
                        <li><a class="" href="http://invoices.techhut.live/admin/business"><i class="fa fa-briefcase"></i> <span class="hidden-xs">Business</span></a></li>
                        <li><a class="" href="http://invoices.techhut.live/admin/business/invoice_customize"><i class="fa fa-file-text"></i> <span class="hidden-xs">Invoice Customization</span></a></li>
                     </ul> 
                              ...
                              <div class="form-group">
                                 <div class="avatar-upload text-center">
                                    ...
                                    <div class="avatar-preview">
                                       <div id="imagePreview" style="background-image: {{ Sentinel::getUser()->image }};">
                                       </div>
                                    </div>
                                 </div>
                              </div>
